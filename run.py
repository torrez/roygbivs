...
parser.add_argument("--environment", "-e", default="development", help='development, production, or testing')
args = parser.parse_args()

environment = roygbivs.RoygbivsApplication.get_environment(args.environment)

print(" 🚀  starting in {0} mode.".format(roygbivs.RoygbivsApplication.environment_as_string(environment)))
